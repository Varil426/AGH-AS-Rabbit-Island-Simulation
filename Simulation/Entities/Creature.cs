...
namespace Simulation.Entities
{
    public abstract class Creature : Entity, ICreature
    {
        ...
        protected Creature(Vector2 position, World world) : base(position, world)
        {
            ...
            _moveDirection = new RelativePosition(this, RelativePosition.Direction.North, World);
        }
        ...
        protected void MoveAway(EntitiesGroup entitiesGroup)
        {
            ...
            var distance = MovementSpeed * timeDifference.TotalMinutes * World.WorldConfig.TimeRate;
            var newPosition = Position + finalDirection * (float)distance;
            if (newPosition.X <= World.WorldMap.Size.Item1
                && newPosition.X >= 0
                && newPosition.Y <= World.WorldMap.Size.Item2
                && newPosition.Y >= 0)
            {
        ...
        public bool CanMate => CreatedAt.AddMilliseconds((1000 * 60 * 60) / World.WorldConfig.TimeRate) <= DateTime.Now;
        ...
        protected virtual void UpdateStateSelf()
        {
            ...
            DeathFromOldAge();
            // TODO Change this
            var timeRate = World.WorldConfig.TimeRate;
        ...
        {
            return World.GetCloseByEntities(this);
        }
